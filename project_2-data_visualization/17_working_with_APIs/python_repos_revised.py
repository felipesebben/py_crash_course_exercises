...
def get_response():
    """ Make an API call and store the returned response."""
...
def get_repo_dicts(r):
    """Store response in a set of dicts containing the most popular repos."""
...
def make_visualization(repo_links, stars, labels):
    ...
    offline.plot(fig, filename='python_repos_revisited.html')
